...
if (command == 'play', 'ytplay', 'youtubeplay') {
  try {
    if (!text) {
      return conn.reply(m.chat, `Gunakan contoh ${usedPrefix}${command} All my Fellas`, m);
    }
...
handler.command = ['play', 'ytplay', 'youtubeplay', 'ytlist', 'youtubelist', 'ytl', 'yts', 'youtubesearch']
handler.limit = true 
